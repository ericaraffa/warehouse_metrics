...
public class KeyValueManager {
    ...
    // Insert a key-value pair into the database (DRAFT)
    public void putValue(String userId, String wishlistId, String productId, String attributeName, String value) {
        openDB();
    ...
    public void browseWishlist(String userId) {
        openDB();
